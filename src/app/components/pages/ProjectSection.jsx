...
const projectsData = [
  ...
  },
  {
    ...
    title: "Forever",
    description:
      "Forever is a full-stack e-commerce platform that blends timeless style with everyday convenience. The user-facing site is built with React and Vite, styled using Tailwind CSS, and currently serves product data via JSON while backend services are offline due to hosting limitations. The complete system includes an admin dashboard built in Next.js with TypeScript, a Node.js and Express backend, MongoDB for data storage, and Cloudinary for image management. Designed to deliver a smooth shopping experience, Forever highlights modular design, scalability, and user-focused UX.",
    shortDescription: "Full-Stack E-Commerce Website with Admin Dashboard",
    technologies: [
    ...
    image: "/images/projects/Forever1.png",
    tag: ["All", "Web"],
    images: [
      "Forever1.png",
      "Forever2.png",
    ...
    gitUrl: "https://github.com/alverarevalo30/e-commerce/tree/main/frontend",
    previewUrl: "https://e-commerce-alverarevalo.vercel.app/",
  },
  {
    id: 3,
    title: "Foodie",
